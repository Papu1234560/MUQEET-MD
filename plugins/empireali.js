...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: { url: "https://files.catbox.moe/76te5r.jpg" },
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "923163954173@s.whatsapp.net", // Replace with staff contact numbers
                "923163954173@s.whatsapp.net", // Example: Add staff members here
                "923163954173@s.whatsapp.net", // Example: Add staff members here
                "923163954173@s.whatsapp.net", // Example: Add staff members here
                "923163954173@s.whatsapp.net", // Example: Add staff members here
                "923163954173@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩ု᪳𝐌𝐔𝐐𝐄𝐄𝐓-𝐌𝐃ှ᪳𓆪";
            const imageUrl = "https://files.catbox.moe/76te5r.jpg"; // Replace with the actual image URL
