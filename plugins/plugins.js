...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *MUQEET MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*MUQEET MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://files.catbox.moe/76te5r.jpg` }, // Replace with your image URL
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: 'мυqeeт 𝐌Ɗ 𝐒ʊ̊𝐏𝐏๏፝֟ɼʈ 🍁',
                    serverMessageId: 143
                }
            }
        };
